...
class _EditState extends State<Edit> {
  ...
  //inisialize field
  var nama_barang = TextEditingController();
  ...
  Future _getData() async {
    try {
      final response = await http.get(Uri.parse(
          ...
          "http://10.10.22.26/project/php/detail.php?kode_barang='${widget.id}'"));
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          nama_barang = TextEditingController(text: data['nama_barang']);
  ...
  Future _onUpdate(context) async {
    try {
      return await http.post(
        Uri.parse("http://10.10.22.26/project/php/update.php"),
        body: {
          "kode_barang": widget.id,
          "nama_barang": harga.text,
          "harga": harga.text,
        },
      ).then((value) {
  ...
  Future _onDelete(context) async {
    try {
      return await http.post(
        Uri.parse("http://10.10.22.26/project/php/delete.php"),
        body: {
          "id": widget.id,
        },
      ).then((value) {
